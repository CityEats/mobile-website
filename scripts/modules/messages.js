...
function ($, _, app, Data, Helper, City, Restaurant, Reservation, Restaurants, Reservations) {
    ...
    app.commands.setHandler('SetCurrentCity', function (currentCity) {
        if (currentCity) localStorage.setItem('CurrentCity', JSON.stringify(currentCity));
        else localStorage.removeItem('CurrentCity');
    });
    ...
    app.commands.setHandler('API:ContactUs', function (contactInfo, callback) {
        var handler = postJSONStatic(API_PATH + '/web_contact_messages', { web_contact_message: contactInfo });
        handler(callback);
    }); 
    ...
    app.commands.setHandler('ContactUs', function (contactInfo, callback) {
        app.execute('API:ContactUs', contactInfo, callback);
    });
